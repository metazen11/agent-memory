...
# Eval Report: class-b-qwen2.5-3b-toolcalls-v2-q6k-2026-05-15

**Run date:** 2026-05-15
**Eval class:** B

> **Verdict: PASS [OK]** — Class B adaptation: 90% adapt-or-answer, 10% identical re-emit, text_answer 0/30.
>
...
|---|---|---|---|---|
| adaptation rate | >= 70 | 90.0% | PASS | (adapted+text)/total = 27+0/30 |
| identical_reemit rate | <= 20 | 10.0% | PASS | 3/30 sessions re-emitted exactly the prior call (v2 loop bug) |
| text_answer rate | >= 30 | 0.0% | FAIL | 0/30 synthesized a final text reply after seeing the tool result |
...
| 2 | try again | identical_reemit | 4 | identical_reemit |
| 3 | yes | adapted_tool_call | 4 | — |
| 4 | wfca.local keeps reloading in a loop | adapted_tool_call | 4 | — |
| 5 | try again | adapted_tool_call | 4 | — |
...
| 9 | try again | adapted_tool_call | 4 | — |
| 10 | putoutstanding into github issues if they have none then quality gate... | adapted_tool_call | 4 | — |
| 11 | ok so materialized views seem to be slowing everything down then? | adapted_tool_call | 4 | — |
| 12 | wait i still don't understandy why /mz/_coding/anvil doesn't have the... | adapted_tool_call | 4 | — |
| 13 | so i would like to see the outcomes if there is any data in there ale... | adapted_tool_call | 4 | — |
| 14 | ok let's pr to dev and go through ci/cd - | adapted_tool_call | 4 | — |
| 15 | ok the last bit i think would be to surface detections as part of our... | adapted_tool_call | 4 | — |
| 16 | please get his working on our current local instance with the current... | adapted_tool_call | 4 | — |
| 17 | ok please create professional tickets for all these issues with prope... | adapted_tool_call | 4 | — |
| 18 | putoutstanding into github issues if they have none then quality gate... | adapted_tool_call | 4 | — |
| 19 | keep going :   Already existed (discovered & closed):   - Loop detect... | identical_reemit | 4 | identical_reemit |
| 20 | should we ensure that dropbox is fully merged and working and cleaned... | adapted_tool_call | 4 | — |
| 21 | keep going :   Already existed (discovered & closed):   - Loop detect... | identical_reemit | 4 | identical_reemit |
| 22 | [Image: source: /Users/mz/Dropbox/Screenshots/SCR-20260429-hjya.png] | adapted_tool_call | 4 | — |
| 23 | should we be deploying the etl by merging our etl repo changes into d... | adapted_tool_call | 4 | — |
...
| Metric | Value |
|---|---|
| adapted_tool_call | 27/30 |
| text_answer | 0/30 |
| identical_reemit | 3/30 |
| off_topic | 0/30 |
| error | 0/30 |
| adaptation_rate_pct | 90.0 |
| identical_reemit_pct | 10.0 |
| sample_seed | 23 |
...
- **raw transcripts** — `tests/fine_tune/real_world/baselines/class-b-v2.results.json`
