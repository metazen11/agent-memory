...
# Eval Report: class-d-v1-20260515

**Run date:** 2026-05-15
**Eval class:** D

> **Verdict: PASS [OK]** — Class D validator: parse 95% (19/20), schema_valid 95% (19/20), empty_args_emissions=0.
>
...
|---|---|---|---|---|
| parse_rate | >= 80 | 95.0% | PASS | 19/20 trials parsed as a valid tool_call |
| schema_valid rate | >= 70 | 95.0% | PASS | 19/20 trials parsed AND validated against the tool's JSON schema |
| native_tool_calls | >= 1 | 19 count | PASS | 19/20 returned via OpenAI tool_calls field (vs <tool_call> in content) |
...
| 7 | Search the repo for the string 'parse_tool_call'. | useful_answer | 1 | — |
| 8 | Grep for TODO comments in app/. | useful_answer | 1 | — |
| 9 | Search src/ for the symbol `redact_json`. | useful_answer | 1 | — |
| 10 | Change the version string from 1.0.0 to 1.0.1 in package.json. | error | 1 | — |
...
| 18 | Search the codebase for any function named `parse_tool_call`. | useful_answer | 1 | — |
| 19 | Find all .py files in the src directory. | useful_answer | 1 | — |
...
| parsed | 19/20 |
| schema_valid | 19/20 |
| native_tool_calls | 19/20 |
| parse_rate_pct | 95.0 |
| valid_rate_pct | 95.0 |
| in_distribution_parsed | 14/15 |
| natural_parsed | 5/5 |
...
- **validator raw report** — `/Users/mz/_CODING/agentMemory/tests/fine_tune/real_world/baselines/_class_d_v1/validate_openai_20260515T155616Z.json`
