...
# Eval Report: class-e-qwen2.5-3b-toolcalls-v1-2026-05-15

**Run date:** 2026-05-15
**Eval class:** custom

> **Verdict: PASS [OK]** — Class E recall: 8/12 PASS, 1/12 PARTIAL, 3/12 FAIL.
>
...
|---|---|---|---|---|
| PASS rate | >= 50 | 66.7% | PASS | 8/12 responses mention concrete project files/concepts |
| FAIL rate | <= 30 | 25.0% | PASS | 3/12 responses are generic with no project-specific signal |
...
| 2 | what's the dispatch in Daily Dispatch? | text_only_fallback | 1 | — |
| 3 | where does the fire map data come from? | useful_answer | 1 | — |
...
| 6 | describe the v2 retrain pipeline | useful_answer | 1 | — |
| 7 | what's the empty-args loop bug? | text_only_fallback | 1 | — |
| 8 | show me how Fire Map's layer panel resolves user permissions | text_answer | 1 | — |
...
- **raw transcripts** — `tests/fine_tune/real_world/baselines/class-e-v1.results.json`
